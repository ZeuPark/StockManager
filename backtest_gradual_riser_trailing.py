                ...
                if trailing_active:
                    ...
                    if (peak_price - buy_price) / buy_price >= 0.02:
                        if price <= peak_price * 0.985:
                            ...
                            break
                # RSI 기준 트레일링 시작
                if not trailing_active and srow['rsi'] >= 75:
...
results_df.to_csv('backtest_gradual_riser_trailing.csv', index=False, encoding='utf-8-sig') 